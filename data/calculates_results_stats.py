...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # total correct dogs
        if res_value[3] == 1 and res_value[4] == 1:
            results_stats_dic['n_correct_dogs'] += 1
        
        #  total correct not dogs
        if res_value[3] == 0 and res_value[4] == 0:
        ...
        # total correct breeds
        if res_value[3] == 1 and res_value[2] == 1:
