...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("{:30}: {:.2f}".format('% correct Dogs', results_stats_dic['pct_correct_dogs']))
    print("{:30}: {:.2f}".format('% correct Breed', results_stats_dic['pct_correct_breed']))
    print("{:30}: {:.2f}".format('% correct "Not a" Dog',  results_stats_dic['pct_correct_notdogs']))
    print("{:30}: {:.2f}".format('% match', results_stats_dic['pct_match']))


    # Case #1 print_incorrect_dogs == True AND there were images incorrectly 
        ...
        for key in results_dic:
            ...
            if sum(results_dic[key][3:]) == 1:
                if results_dic[key][3] == 1:
                    print('{} is-a-dog and {} as is-NOT-a-dog'.format(results_dic[key][0], results_dic[key][1]))
                else:
                    print('{} is-NOT-a-dog and {}  is-a-dog'.format(results_dic[key][0], results_dic[key][1]))
